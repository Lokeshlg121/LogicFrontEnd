...
signupForm.addEventListener('submit', async (e) => {
    ...
    try {
        const response = await fetch('http://35.94.170.31:3000/signup', { // Replace with your actual signup API URL
            method: 'POST',
            headers: {
...
loginForm.addEventListener('submit', async (e) => {
    ...
    try {
        const response = await fetch('http://35.94.170.31:3000/login', { // Replace with your actual login API URL
            method: 'POST',
            headers: {
                'Content-Type': 'application/json'
            },
